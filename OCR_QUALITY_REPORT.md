...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| AXB | axb | 9 | 100% | 100% | 100% | 89% | 100% | 89% | 100% | 100% | 33% | 89% |
| Антарес | antares | 10 | 100% | 100% | 90% | 100% | 100% | 100% | 100% | 100% | 100% | 100% |
| Грузовые резервы | gruzovye_rezervy | 15 | 93% | 100% | 93% | 47% | 93% | 100% | 100% | 93% | 100% | 47% |
| ЕТС | ets_act | 10 | 80% | 100% | 80% | 80% | 90% | 100% | 80% | 90% | 100% | 80% |
| ЛидерТрак | leader_trak | 24 | 100% | 100% | 100% | 100% | 96% | 100% | 100% | 96% | 100% | 100% |
| Логистика | logistics | 10 | 100% | 100% | 100% | 60% | 100% | 100% | 100% | 90% | 90% | 60% |
| СибТракСкан | sibtrakscan | 17 | 100% | 100% | 0% | 100% | 100% | 100% | 100% | 100% | 100% | 100% |

## Priority Queue

- `AXB` / `axb`: score 21 on 9 docs. Main issues: mileage_missing.
- `Грузовые резервы` / `gruzovye_rezervy`: score 20 on 15 docs. Main issues: mileage_missing, order_number_missing.
- `Логистика` / `logistics`: score 14 on 10 docs. Main issues: mileage_missing.
- `ЕТС` / `ets_act`: score 9 on 10 docs. Main issues: order_number_missing, mileage_missing.
- `ЛидерТрак` / `leader_trak`: score 4 on 24 docs. Main issues: line_items_missing.
...
- Extract failure: `-`
- Header: order `0000020577`, date `2025-05-02`, plate `BY167016`, vin `NPFCGSV30PA000038`, mileage `296723`
...
- Extract source: `pdf_vision_ocr`
- Extract failure: `-`
- Header: order `0000018125`, date `2025-01-15`, plate `0894YX716`, vin `LGAG3DV20P8831661`, mileage `329100`
- Totals: work `1425.0`, parts `-`, vat `-`, grand `1425.0`
- Line items: works `1`, parts `0`
- Manual review: `-`
...
- Extract source: `pdf_vision_ocr`
- Extract failure: `-`
- Header: order `0000021658`, date `2025-07-02`, plate `BB044416`, vin `WSM00000003313941`, mileage `-`
- Totals: work `43023.6`, parts `2450.54`, vat `-`, grand `45474.14`
- Line items: works `7`, parts `0`
- Manual review: `mileage_missing`
...
- Totals: work `12585.6`, parts `66.0`, vat `-`, grand `12648.3`
- Line items: works `4`, parts `0`
- Manual review: `-`
...
- Extract source: `pdf_vision_ocr`
- Extract failure: `-`
- Header: order `0000018636`, date `2025-02-07`, plate `BУ008616`, vin `NPFCGSV30PA000016`, mileage `104257`
...
- Extract failure: `-`
- Header: order `A0000017944`, date `2025-01-04`, plate `K324BA716`, vin `X9PRG20A4MW137888`, mileage `753500`
- Totals: work `35052.0`, parts `56247.65`, vat `15216.62`, grand `91299.65`
- Line items: works `16`, parts `10`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000018822`, date `2025-03-28`, plate `K104CO716`, vin `X9PRG20A7MW139201`, mileage `780340`
- Totals: work `37536.0`, parts `101475.69`, vat `23168.59`, grand `139011.69`
- Line items: works `13`, parts `18`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000020458`, date `2025-09-09`, plate `A076EC716`, vin `-`, mileage `1675500`
- Totals: work `18348.0`, parts `60662.99`, vat `13168.5`, grand `79010.99`
- Line items: works `10`, parts `9`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000019619`, date `2025-06-14`, plate `K060BA716`, vin `X9PRG20A4MW137891`, mileage `950500`
- Totals: work `7728.0`, parts `88197.25`, vat `15987.54`, grand `95925.25`
- Line items: works `3`, parts `4`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000019693`, date `2025-06-21`, plate `A513CE716`, vin `X9PRG20A7JW120532`, mileage `1601957`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000019751`, date `2025-06-29`, plate `K296AH716`, vin `X9PRG20A3MW137834`, mileage `890765`
- Totals: work `25392.0`, parts `44863.78`, vat `11709.3`, grand `70255.78`
- Line items: works `9`, parts `2`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000021909`, date `2026-01-22`, plate `K035CO716`, vin `X9PRG20A7MW139215`, mileage `875597`
- Totals: work `42164.6`, parts `68227.01`, vat `19906.69`, grand `110391.61`
- Line items: works `13`, parts `24`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000022257`, date `2026-02-20`, plate `K915AH716`, vin `X9PRG20A7MW137884`, mileage `1100000`
- Totals: work `44231.8`, parts `88196.73`, vat `23880.57`, grand `132428.53`
- Line items: works `18`, parts `16`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000020901`, date `2025-10-18`, plate `K357BA716`, vin `X9PRG20A1MW137931`, mileage `963609`
- Totals: work `38854.0`, parts `73924.24`, vat `18796.38`, grand `112778.24`
- Line items: works `15`, parts `14`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `A0000021469`, date `2025-12-06`, plate `K346CO716`, vin `X9PRG30A1MW139233`, mileage `918672`
- Totals: work `34144.0`, parts `298541.09`, vat `55447.52`, grand `332685.09`
- Line items: works `13`, parts `14`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000210722`, date `2026-01-19`, plate `ВУ296516`, vin `NLS3DFFSTP1064773`, mileage `-`
- Totals: work `69165.0`, parts `120656.0`, vat `34230.02`, grand `189821.0`
- Line items: works `6`, parts `7`
- Manual review: `mileage_missing`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000215622`, date `2026-02-12`, plate `С163МК716`, vin `LGAG3DV22P8837316`, mileage `462501`
- Totals: work `25420.0`, parts `80279.0`, vat `19060.49`, grand `105699.0`
- Line items: works `11`, parts `9`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000216975`, date `2026-02-18`, plate `С763РЕ716`, vin `LGAG3DV21P8840756`, mileage `353673`
- Totals: work `64790.0`, parts `184989.0`, vat `45042.12`, grand `249779.0`
- Line items: works `20`, parts `24`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000210188`, date `2026-01-16`, plate `С611РН716`, vin `LGAG3DV29P8841394`, mileage `370200`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000213716`, date `2026-02-02`, plate `С863МС716`, vin `LGAG3DV28P8839118`, mileage `489872`
- Totals: work `59985.0`, parts `159920.0`, vat `39655.01`, grand `219905.0`
- Line items: works `12`, parts `25`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000217211`, date `2026-02-19`, plate `ВА491116`, vin `X1Y908400R3279932`, mileage `1514135`
- Totals: work `105270.0`, parts `170771.0`, vat `49777.86`, grand `276041.0`
- Line items: works `16`, parts `24`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000218352`, date `2026-02-25`, plate `ВУ264316`, vin `NLS3DFFSTP1064738`, mileage `-`
- Totals: work `79050.0`, parts `105595.0`, vat `33296.66`, grand `184645.0`
- Line items: works `10`, parts `4`
- Manual review: `mileage_missing`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000219918`, date `2026-03-05`, plate `К104СО716`, vin `X9PRG20A7MW139201`, mileage `988552`
- Totals: work `31930.0`, parts `66766.0`, vat `17797.63`, grand `98696.0`
- Line items: works `12`, parts `5`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ГП000220799`, date `2026-03-10`, plate `ВВ269416`, vin `WSM00000003313952`, mileage `-`
- Totals: work `68820.0`, parts `96156.0`, vat `29749.77`, grand `164976.0`
- Line items: works `11`, parts `16`
- Manual review: `mileage_missing`
...
- Manual review: `order_number_missing, mileage_missing`
...
- Extract source: `pdf_vision_ocr`
- Extract failure: `-`
- Header: order `-`, date `2025-02-03`, plate `К350ВА716`, vin `-`, mileage `-`
- Totals: work `900.0`, parts `300.0`, vat `-`, grand `-`
...
- Extract source: `pdf_vision_ocr`
- Extract failure: `-`
- Header: order `-`, date `2025-01-06`, plate `А773НР716`, vin `-`, mileage `-`
- Totals: work `-`, parts `6.0`, vat `-`, grand `-`
- Line items: works `0`, parts `1`
- Manual review: `order_number_missing, mileage_missing`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `81121`, date `2025-03-03`, plate `А477НХ716`, vin `X9PRG20A8JW120667`, mileage `450320`
- Totals: work `10150.0`, parts `52559.67`, vat `12541.93`, grand `75251.6`
- Line items: works `3`, parts `2`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `81459`, date `2025-03-15`, plate `К346СО716`, vin `X9PRG30A1MW139233`, mileage `190`
- Totals: work `28040.0`, parts `81086.58`, vat `21825.31`, grand `130951.89`
- Line items: works `18`, parts `20`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `83139`, date `2025-05-14`, plate `А604ХВ116`, vin `X9PRG20A9HW117657`, mileage `606098`
- Totals: work `22040.0`, parts `46103.16`, vat `13628.64`, grand `81771.8`
- Line items: works `11`, parts `4`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `88169`, date `2025-11-08`, plate `К662ВА716`, vin `X9PRG20A5LW131404`, mileage `203040`
- Totals: work `24840.0`, parts `8188.02`, vat `6605.6`, grand `39633.62`
- Line items: works `8`, parts `7`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `89771`, date `2026-01-07`, plate `К229ВА716`, vin `X9PRG20A7MW137903`, mileage `29326`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `91111`, date `2026-02-21`, plate `С847МС716`, vin `LGAG3DV20P8839131`, mileage `570`
- Totals: work `33150.0`, parts `67065.92`, vat `22047.51`, grand `122263.43`
- Line items: works `5`, parts `8`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `84995`, date `2025-07-20`, plate `А513СЕ716`, vin `X9PRG20A7JW120532`, mileage `621086`
- Totals: work `17030.0`, parts `56109.96`, vat `14627.99`, grand `87767.95`
- Line items: works `13`, parts `13`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `87067`, date `2025-10-01`, plate `К296АН716`, vin `X9PRG20A3MW137834`, mileage `110`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250002311`, date `2025-02-28`, plate `091СЕМ716`, vin `LGAG3DV28P8834744`, mileage `229142`
- Totals: work `54484.18`, parts `96139.18`, vat `30553.14`, grand `183319.0`
- Line items: works `19`, parts `15`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250004899`, date `2025-05-12`, plate `831ОТТ716`, vin `LGAG3DV22P8830897`, mileage `416695`
- Totals: work `28520.83`, parts `80164.17`, vat `21737.0`, grand `130422.0`
- Line items: works `5`, parts `1`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250005926`, date `2025-06-13`, plate `0443ВВ16`, vin `X1Y908400R3313945`, mileage `1146856`
- Totals: work `56360.84`, parts `132210.85`, vat `37714.31`, grand `226286.0`
- Line items: works `17`, parts `30`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250007012`, date `2025-07-17`, plate `699КВА716`, vin `X9PRG20A4KW129853`, mileage `1198697`
- Totals: work `104235.85`, parts `326750.83`, vat `86197.32`, grand `517184.0`
- Line items: works `46`, parts `33`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250008749`, date `2025-09-10`, plate `115СКХ716`, vin `LGAG3DV20P8837458`, mileage `401093`
- Totals: work `13054.17`, parts `79063.33`, vat `18423.5`, grand `110541.0`
- Line items: works `4`, parts `3`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250008887`, date `2025-09-13`, plate `LM1109910`, vin `LGAG3DV25P8834118`, mileage `494732`
- Totals: work `61767.5`, parts `155636.67`, vat `43480.83`, grand `260885.0`
- Line items: works `17`, parts `23`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250009047`, date `2025-09-18`, plate `667КВА716`, vin `X9PRG20AXLW132788`, mileage `1163000`
- Totals: work `62220.84`, parts `248037.5`, vat `63444.33`, grand `380666.0`
- Line items: works `26`, parts `19`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250009582`, date `2025-10-03`, plate `7322ВР16`, vin `NLFS3010000056659`, mileage `270045`
- Totals: work `72120.82`, parts `234125.84`, vat `61249.34`, grand `367496.0`
- Line items: works `13`, parts `11`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250010000`, date `2025-10-17`, plate `602СРН716`, vin `LGAG3DV25P8841313`, mileage `344141`
- Totals: work `52200.0`, parts `142236.64`, vat `38887.36`, grand `233324.0`
- Line items: works `23`, parts `22`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250010044`, date `2025-10-18`, plate `587СРН716`, vin `LGAG3DV23P8841391`, mileage `295566`
- Totals: work `67070.84`, parts `121350.82`, vat `37684.34`, grand `226106.0`
- Line items: works `24`, parts `24`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250010740`, date `2025-11-08`, plate `JY914296`, vin `XJY914296P0000588`, mileage `1`
- Totals: work `56695.83`, parts `136035.83`, vat `38546.34`, grand `231278.0`
- Line items: works `17`, parts `13`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250010860`, date `2025-11-12`, plate `0441ВВ16`, vin `WSM00000005208659`, mileage `1230984`
- Totals: work `25515.01`, parts `72250.83`, vat `19553.16`, grand `117319.0`
- Line items: works `9`, parts `9`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250011521`, date `2025-12-06`, plate `182КВА716`, vin `X9PRG20A3LW130672`, mileage `1286591`
- Totals: work `111684.15`, parts `259113.34`, vat `88013.01`, grand `528078.0`
- Line items: works `23`, parts `19`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012276`, date `2025-12-25`, plate `879КВА716`, vin `X9PRG20A4MW137776`, mileage `953917`
- Totals: work `32035.83`, parts `37990.84`, vat `14005.33`, grand `84032.0`
- Line items: works `20`, parts `12`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012296`, date `2025-12-30`, plate `867СМТ716`, vin `XU557582AP3000201`, mileage `247802`
- Totals: work `24829.16`, parts `24554.17`, vat `9876.67`, grand `59260.0`
- Line items: works `5`, parts `23`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012319`, date `2025-12-27`, plate `4895ВН16`, vin `X1Y908400R3275536`, mileage `1709955`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012335`, date `2025-12-27`, plate `299СМР716`, vin `XU557582AP3000197`, mileage `220088`
- Totals: work `22256.67`, parts `22222.51`, vat `8895.82`, grand `53375.0`
- Line items: works `5`, parts `15`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012346`, date `2025-12-26`, plate `JY914296`, vin `XJY914296P0000575`, mileage `1`
- Totals: work `-`, parts `25967.0`, vat `1577.0`, grand `9462.0`
- Line items: works `0`, parts `5`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012362`, date `2025-12-27`, plate `168СМК716`, vin `LGAG3DV29P8837586`, mileage `541316`
- Totals: work `54324.16`, parts `80585.83`, vat `26982.01`, grand `161892.0`
- Line items: works `23`, parts `13`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012373`, date `2025-12-27`, plate `324КВА716`, vin `X9PRG20A4MW137888`, mileage `962300`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012397`, date `2025-12-28`, plate `JY914296`, vin `XJY914296P0000587`, mileage `14`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012414`, date `2025-12-29`, plate `915КАН716`, vin `X9PRG20A7MW137884`, mileage `1043787`
- Totals: work `31849.99`, parts `230554.18`, vat `52480.83`, grand `314885.0`
- Line items: works `15`, parts `12`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012416`, date `2025-12-29`, plate `263ОТВ716`, vin `LGAG3DV24P8831596`, mileage `599440`
- Totals: work `32480.84`, parts `104515.83`, vat `27399.33`, grand `164396.0`
- Line items: works `13`, parts `21`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `ЛТ250012417`, date `2025-12-30`, plate `0441ВВ16`, vin `WSM00000005208659`, mileage `1230984`
- Totals: work `35874.17`, parts `7171.67`, vat `8969.16`, grand `53815.0`
- Line items: works `9`, parts `6`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000001633`, date `2025-09-30`, plate `ВО015616`, vin `NLFS3010000057266`, mileage `-`
- Totals: work `20439.98`, parts `13329.35`, vat `-`, grand `33769.33`
- Line items: works `1`, parts `4`
- Manual review: `mileage_missing`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000001919`, date `2025-11-05`, plate `ВУ008616`, vin `NPFCGSV30PA000016`, mileage `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000002109`, date `2025-11-26`, plate `ВВ038916`, vin `X1Y908400R3313900`, mileage `-`
- Totals: work `5431.99`, parts `756.3`, vat `-`, grand `6188.29`
- Line items: works `1`, parts `2`
- Manual review: `mileage_missing`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000002318`, date `2025-12-15`, plate `ВО015716`, vin `NLFS3010000056568`, mileage `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000002472`, date `2026-01-14`, plate `У026АХ716`, vin `LGAG3DV29R8846629`, mileage `716`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000002676`, date `2026-01-31`, plate `С113КХ716`, vin `LGAG3DV2XP8837385`, mileage `450000`
- Totals: work `21349.98`, parts `80677.45`, vat `-`, grand `102027.43`
- Line items: works `1`, parts `5`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000002864`, date `2026-02-24`, plate `С113КХ716`, vin `LGAG3DV2XP8837385`, mileage `462000`
- Totals: work `7568.62`, parts `3367.2`, vat `-`, grand `10935.82`
- Line items: works `0`, parts `4`
- Manual review: `-`
...
- Extract source: `pdf_text`
- Extract failure: `-`
- Header: order `00000000906`, date `2025-06-20`, plate `С027НМ716`, vin `LGAG3DV22P8839132`, mileage `270239`
