...
import { qualityCards, summaryCards, workspaceTabDescriptions } from "../shared/appUiConfig";
import {
  buildDataQualityProps,
  buildImportConflictDialogProps,
  buildWorkspaceChromeProps,
} from "./buildWorkspaceShellProps";
import { buildDashboardVisualBarWidth } from "../shared/dashboardVisuals";
import {
  formatConfidence,
  formatDateTime,
  formatJsonPretty,
...
import { formatQualityVehicle } from "../entities/vehicle/helpers";
...
export type BuildWorkspaceMainViewPropsParams = {
...
export function buildWorkspaceMainViewProps(params: BuildWorkspaceMainViewPropsParams): WorkspaceMainViewProps {
  ...
  return {
    chromeProps: buildWorkspaceChromeProps({
      ...
      selectedRepair: rootState.activeWorkspaceTab === "repair" ? rootState.selectedRepair : null,
      showTechAdminTab: rootState.showTechAdminTab,
      vehicles: params.fleetWorkspace.vehicleOptions,
    ...
    importConflictDialogProps: buildImportConflictDialogProps({
      ...
      closeImportConflictDialog: historicalImportsAdmin.closeImportConflictDialog,
